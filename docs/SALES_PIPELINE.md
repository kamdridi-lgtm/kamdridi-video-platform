# KAMDRIDI Visuals — Cash-First Sales Pipeline
...
- No subscription
- Custom project using the artist's song, artwork/photos and visual direction
...
1. Research up to 5 strong prospects.
2. Verify the artist/release/contact route before outreach.
3. Personalize the first sentence.
4. Send one short message.
5. Record the contact date/channel/status.
6. Follow up once after 3–4 days if there is no reply.
7. Stop if declined.
8. If interested, send the official $99 purchase path.
